...
<title>Picked up Vehicles</title>
<style>
table, th, td {
...
<body>
	<jsp:include page="CarrierMyVehicleHeader.jsp" />
		...
		for (Posts post : posts) {
			...
			if (post.getPickedup() == 1 && post.getDelivered() == 0) {
				count++;
				%>
		<tr>
	...
	<% if(count != 0){ 
		%>
		<form method="post" action="/A-DISPATCH/HandleCarrierPickupVehicles" >
		<p align="center">
			<B>Set Load As Delivered</B><br>
